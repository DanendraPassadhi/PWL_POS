                ...
                <div class="form-group">
                    ...
                    <div class="mb-3">
                        <img id="profile_preview"
                            src="{{ Auth::user()->profile_picture && Storage::disk('public')->exists('profile/' . Auth::user()->profile_picture) ? asset('storage/profile/' . Auth::user()->profile_picture) : asset('profile.png') }}"
