...
class KategoriController extends Controller
{
    ...
    {
        $kategori = KategoriModel::select('id', 'kategori_id', 'kategori_nama');
    ...
    public function store_ajax(Request $request) {
        ...
        if($request->ajax() || $request->wantsJson()) {
            $rules = [
                'kategori_id' => 'required|string|max:10|unique:m_kategori,kategori_id',
    ...
    public function update_ajax(Request $request, $id)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'kategori_id' => 'required|max:10|unique:m_kategori,kategori_id,'.$id.',id',
