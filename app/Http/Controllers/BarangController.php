...
class BarangController extends Controller
{
    public function index()
    {
        ...
        $kategori = KategoriModel::select('id', 'kategori_nama')->get();
    ...
    {
        $barang = BarangModel::select('barang_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual', 'kategori_id', 'supplier_id')->with('kategori', 'supplier');
    ...
    public function store_ajax(Request $request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'kategori_id' => ['required', 'integer', 'exists:m_kategori,id'],
                'barang_kode' => ['required', 'min:3', 'max:20', 'unique:m_barang,barang_kode'],
                'barang_nama' => ['required', 'string', 'max:100'],
                'harga_beli' => ['required', 'numeric'],
                'harga_jual' => ['required', 'numeric'],
                'supplier_id' => ['required', 'integer', 'exists:m_supplier,id'],
            ];
    ...
    public function export_excel()
    {
        ...
        foreach ($barang as $key => $value) {
            ...
            $sheet->setCellValue('G' . $baris, $value->supplier->supplier_nama); // ambil nama supplier
